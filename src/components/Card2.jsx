import image from "../assets/nft2.png"
...
export default function Card2({id, name, message, category, value, timeLeft}) {
  ...
  return (
    <div className="pb-10 m-10 rounded-xl  flex flex-col gap-6 bg-gray-900 p-6 text-blue-300/80 max-w-[350px]">
      ...
      <div className="flex justify-between">
        <span className="flex gap-2 text-green-500 font-bold"><img src={iconEthereum} alt=""/><span>{value} $JUBA</span></span>

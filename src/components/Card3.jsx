...
export default function Card3({id, name, message, category, value, timeLeft}) {
  ...
  return (
    <div className="pb-10 m-10 rounded-xl  flex flex-col gap-6 bg-gray-900 p-6 text-blue-300/80 max-w-[350px]">
      ...
      <div className="flex justify-between">
        <span className="flex gap-2 text-green-500 font-bold"><img src={iconEthereum} alt=""/><span>{value} $TATA</span></span>
      ...
      <button type="button" className="bg-[#343333] text-gray-500 mt-1 px-3 py-3 leading-6 font-Manrope text-lg  rounded-md ">Apply</button>
    </div>
  )
}